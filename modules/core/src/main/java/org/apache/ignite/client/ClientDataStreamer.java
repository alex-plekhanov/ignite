...
public interface ClientDataStreamer<K, V> extends AutoCloseable {
     ...
     */
    public Future<?> removeData(K key) throws CacheException, IgniteInterruptedException, IllegalStateException;
     ...
     * @see #allowOverwrite()
     */
    public Future<?> addData(K key, @Nullable V val) throws CacheException, IgniteInterruptedException,
     ...
     * @see #allowOverwrite()
     */
    public Future<?> addData(Map.Entry<K, V> entry) throws CacheException, IgniteInterruptedException,
        IllegalStateException, IgniteDataStreamerTimeoutException;
     ...
     * @see #allowOverwrite()
     */
    public Future<?> addData(Collection<? extends Map.Entry<K, V>> entries) throws IllegalStateException,
     ...
     * @see #allowOverwrite()
     */
    public Future<?> addData(Map<K, V> entries) throws IllegalStateException,
        IgniteDataStreamerTimeoutException;
