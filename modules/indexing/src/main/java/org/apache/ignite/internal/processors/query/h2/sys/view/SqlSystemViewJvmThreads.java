...
/**
 * Meta view: JVM threads.
 */
public class SqlSystemViewJvmThreads extends SqlAbstractLocalSystemView {
    /**
     * @param ctx Grid context.
     */
    public SqlSystemViewJvmThreads(GridKernalContext ctx) {
    ...
    @Override public Iterator<Row> getRows(Session ses, SearchRow first, SearchRow last) {
        ...
        if (idCond.isEquality()) {
            ...
            threads = mxBean.getThreadInfo(new long[] { idCond.valueForEquality().getLong() },
