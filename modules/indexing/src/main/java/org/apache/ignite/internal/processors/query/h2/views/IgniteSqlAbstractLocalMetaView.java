 ...
 */
public abstract class IgniteSqlAbstractLocalMetaView extends IgniteSqlAbstractMetaView {
    /**
     ...
     * @param cols Columns.
     */
    public IgniteSqlAbstractLocalMetaView(String tblName, String desc, GridKernalContext ctx, String[] indexes, Column... cols) {
     ...
     * @param cols Columns.
     */
    public IgniteSqlAbstractLocalMetaView(String tblName, String desc, GridKernalContext ctx, Column... cols) {
        ...
        public ParentChildRowIterator(final Session ses, Iterator<P> parentIter,
            ...
            super(parentIter, cloChildIter, new IgniteBiClosure<P, C, Row>() {
                ...
                @Override public Row apply(P p, C c) {
                    return IgniteSqlAbstractLocalMetaView.this.createRow(ses, ++rowCnt, cloResFromParentChild.apply(p, c));
                }
            });
        }
    }
