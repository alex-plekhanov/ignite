 ...
 */
public abstract class IgniteSqlAbstractMetaView implements IgniteSqlMetaView {
     ...
     */
    public IgniteSqlAbstractMetaView(String tblName, String desc, GridKernalContext ctx, Column[] cols,
        String[] indexes) {
