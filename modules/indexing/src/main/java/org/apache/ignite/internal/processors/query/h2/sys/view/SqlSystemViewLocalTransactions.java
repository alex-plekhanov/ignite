 ...
 */
public class SqlSystemViewLocalTransactions extends SqlAbstractLocalSystemView {
    /**
     * @param ctx Grid context.
     */
    public SqlSystemViewLocalTransactions(GridKernalContext ctx) {
        super("LOCAL_TRANSACTIONS", "Current node active transactions", ctx,
            ...
            newColumn("IMPLICIT", Value.BOOLEAN),
