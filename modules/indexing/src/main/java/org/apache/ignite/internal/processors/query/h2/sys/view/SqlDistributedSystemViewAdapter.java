 ...
 */
public class SqlDistributedSystemViewAdapter extends SqlAbstractSystemView {
    /** Delegate view. */
    protected final SqlSystemView delegate;
     ...
     */
    public SqlDistributedSystemViewAdapter(String tblName, String desc, GridKernalContext ctx,
        SqlSystemView delegate) {
    ...
    @Override public Iterator<Row> getRows(Session ses, SearchRow first, SearchRow last) {
        return new NodeRowIterator(delegate.getRows(ses, first, last), ctx.localNodeId(), ses);
    }
