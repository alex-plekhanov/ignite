...
/**
 * Meta view: node addresses.
 */
public class SqlSystemViewNodeAddresses extends SqlAbstractLocalSystemView {
    /**
     * @param ctx Grid context.
     */
    public SqlSystemViewNodeAddresses(GridKernalContext ctx) {
    ...
    @Override public Iterator<Row> getRows(Session ses, SearchRow first, SearchRow last) {
        ...
        if (idCond.isEquality()) {
            try {
                ...
                UUID nodeId = UUID.fromString(idCond.valueForEquality().getString());
