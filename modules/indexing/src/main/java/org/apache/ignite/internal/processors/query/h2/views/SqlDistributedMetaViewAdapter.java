 ...
 */
public class SqlDistributedMetaViewAdapter extends SqlAbstractMetaView {
    /** Delegate view. */
    protected final SqlMetaView delegate;
     ...
     */
    public SqlDistributedMetaViewAdapter(String tblName, String desc, GridKernalContext ctx,
        SqlMetaView delegate) {
