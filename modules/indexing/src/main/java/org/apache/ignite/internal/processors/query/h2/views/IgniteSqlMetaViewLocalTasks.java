...
/**
 * Meta view: local tasks.
 */
public class IgniteSqlMetaViewLocalTasks extends IgniteSqlMetaView {
    /**
     * @param ctx Grid context.
     */
    public IgniteSqlMetaViewLocalTasks(GridKernalContext ctx) {
        super("LOCAL_TASKS", "Current node active tasks", ctx,
            newColumn("ID"),
            newColumn("NAME"),
