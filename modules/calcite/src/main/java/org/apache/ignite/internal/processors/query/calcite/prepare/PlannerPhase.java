...
import org.apache.ignite.internal.processors.query.calcite.rule.RelWithExchangeToSpoolRule;
        ...
        @Override public RuleSet getRules(PlanningContext ctx) {
            return ctx.rules(
                RuleSets.ofList(
                    ...
                    RelWithExchangeToSpoolRule.PROJECT,
                    RelWithExchangeToSpoolRule.FILTER,
                    RelWithExchangeToSpoolRule.CNLJ,
