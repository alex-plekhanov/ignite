...
public class JmhDirectByteBufferStreamBenchmark {
    ...
    /** */
    private final ByteBuffer buf = ByteBuffer.allocateDirect(BATCH_SIZE * 25).order(ByteOrder.nativeOrder());
    ...
    public void setup() {
        switch (ver) {
            ...
            default:
                throw new AssertionError("Unknown version " + ver);
        }
...
/*
    public static void main(String[] args) throws Exception {
        JmhDirectByteBufferStreamBenchmark benchmark = new JmhDirectByteBufferStreamBenchmark();
        benchmark.ver = "4";
